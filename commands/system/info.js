	...
	Promise.all(promises)
		.then(results => {
			...
			const embed = new Discord.MessageEmbed()
				...
				.addField(`Versions`, `\`\`\`js\nBlathers: ${obj.version}\nDiscord.js: ${Discord.version}\nNode.js: ${process.versions.node}\`\`\``, true)
				.addField(`Shard Info`, `\`\`\`js\nShard ID: ${client.guilds.cache.first().shardID}\nUptime: ${uptime(client.uptime)}\nUsers: ${client.users.cache.size.toLocaleString()}\nGuilds: ${client.guilds.cache.size.toLocaleString()}\nChannels: ${client.channels.cache.size.toLocaleString()}\nEmojis: ${client.emojis.cache.size.toLocaleString()}\`\`\``, true)
				.addField(`Bot Info`, `\`\`\`js\nShard Count: ${client.shard.count.toLocaleString()}\nUsers: ${totalUsers.toLocaleString()}\nGuilds: ${totalGuilds.toLocaleString()}\nChannels: ${totalChannels.toLocaleString()}\nEmojis: ${totalEmojis.toLocaleString()}\`\`\``,	true)
				.addField(`Links`, `[Invite](https://discordapp.com/api/oauth2/authorize?client_id=598007871720128544&permissions=3533894&scope=bot) | [Vote](https://top.gg/bot/598007871720128544/vote) | [Support Server](https://discord.gg/z6uApMZ) | [Patreon](https://patreon.com/blathers)`, true)
